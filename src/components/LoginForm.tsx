    ...
    <Card className="backdrop-blur-md bg-white/10 border border-white/20 shadow-2xl">
      <CardHeader className="text-center pb-6">
        ...
        <div className="relative group">
          <div className="flex items-center justify-center gap-2 mt-3 text-sm text-gray-200 bg-blue-900/30 px-4 py-2 rounded-lg cursor-help backdrop-blur-sm border border-blue-400/20">
